...
class AdminSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $adminRecords = [
            ...
            ['name' => 'Sub Admin 1', 'type' => 'sub-admin', 'mobile' => '1234567890', 'email' => 'subadmin1@admin.com', 'password' => '$2y$10$Bjo7KGOk07XrRLuQbVFr1urjM4xfdrhkxRa9QaJjFjqCJnrxU4vdG', 'image' => '', 'status' => 1],
