                    ...
                    <div class="card">
                        ...
                        <form autocomplete="off" id="add_donor" name="add_donor" method="POST" action="{{ url('/admin/add-donor') }}" enctype="application/x-www-form-urlencoded">
                            ...
                            <div class="body">
                                <div class="row clearfix">
                                    <div class="col-xs-12">
                                        <h2 class="card-inside-title">Company Name<span style="color: red;"> *</span></h2>
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" class="form-control" id="name" name="name" placeholder="Company Name" autofocus required value="{{ old('name') }}"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    <div class="col-xs-4">
                                        <h2 class="card-inside-title">Contact Name<span style="color: red;"> *</span></h2>
                                        <div class="form-group">
                                            <div class="form-line">
                                    ...
                                    <div class="col-xs-4">
                                        <h2 class="card-inside-title">Contact Email<span style="color: red;"> *</span></h2>
                                        <div class="form-group">
                                            <div class="form-line">
                                    ...
                                    <div class="col-xs-4">
                                        <h2 class="card-inside-title">Contact Number<span style="color: red;"> *</span></h2>
                                        <div class="form-group">
                                            <div class="form-line">
